    ...
    <section className="grid gap-4 rounded-lg border border-black/10 bg-white p-5 shadow-panel xl:grid-cols-[1fr_1.1fr]">
      ...
      <form action={action} className="grid gap-3">
        ...
        <div className="grid gap-2 sm:grid-cols-3">
          <label className="grid gap-2">
            <span className="text-xs font-semibold uppercase text-ink/45">Mínimo para concluir</span>
            <input className="h-10 rounded-md border border-black/10 bg-white px-3 text-sm" defaultValue={defaults.minNewLeads} min={1} max={15} name="minNewLeads" type="number" />
          </label>
          <label className="grid gap-2">
            <span className="text-xs font-semibold uppercase text-ink/45">Máximo para parar</span>
            <input className="h-10 rounded-md border border-black/10 bg-white px-3 text-sm" defaultValue={defaults.targetNewLeads} min={1} max={15} name="targetNewLeads" type="number" />
          </label>
          <label className="grid gap-2">
        ...
        <label className="flex items-center gap-2 rounded-md border border-black/10 bg-[#f7f8f5] px-3 py-2 text-sm">
          ...
          Só concluir após o mínimo e parar no máximo configurado
        </label>
